  ...
  <div>
    ...
    <div class="ccl-left-panel-head-wrap">
      <div class="ccl-left-panel-srch-inpt-wrap">
        ...
        />
        <div id="searchButton" type="button" class="search-btn" />
      </div>
    </div>
