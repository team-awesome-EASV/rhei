<template>
  <div>
    <div
      class="cc1-chat-win-header clearfix"
      v-if="userData.uid || userData.guid"
    >
      <!-- For user -->
      <div class="cc1-chat-win-user">
        <a
          href="javascript:;"
          class="back-btn"
          v-on:click="backToLeft(), showNavigation()"
          >&nbsp;</a
        >
      ...
      <div class="cc1-chat-win-con-opt-wrap">
        ...
        <a
          ...
          class="cc1-chat-win-con-opt details"
          v-on:click="clickMenuOption()"
        ></a>
      </div>
    </div>
  </div>
