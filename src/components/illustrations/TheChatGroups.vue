...
<template>
  <div>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 476.25 236.62">
        ...
        <g id="groups">
          ...
          <g id="groups-right-module">
            ...
            <g id="plus-button">
              ...
              <path
                id="plus"
                d="M264,211.82h7.34v-7.34h4.42v7.34h7.34v4.41h-7.34v7.39h-4.39v-7.39H264Z"
                fill="#fff"
              />
            </g>
          </g>
          <g id="groups-chat-bubble">
            ...
            <g id="groups-chat-bubble-docs">
              ...
              <circle cx="96.18" cy="60.36" r="5.6" fill="#fff" />
              <circle cx="76.89" cy="60.36" r="5.6" fill="#fff" />
            </g>
          </g>
          <text
